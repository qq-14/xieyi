...
sys.path.append(os.path.join(get_package_share_directory('robot_bringup'), 'launch'))
...
def generate_launch_description():
    ...
    launch_params = yaml.safe_load(open(os.path.join(
        get_package_share_directory('robot_bringup'), 'config', 'launch_params.yaml')))


    SetParameter(name='rune',value=launch_params['rune']),
    
    robot_description = Command(['xacro ', os.path.join(
        get_package_share_directory('robot_description'), 'urdf', 'sentry.urdf.xacro'),
    ...
    node_params = os.path.join(
        get_package_share_directory('robot_bringup'), 'config', 'node_params.yaml')
